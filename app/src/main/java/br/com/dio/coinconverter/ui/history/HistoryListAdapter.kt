...
class HistoryListAdapter : ListAdapter<ExchangeResponseValue, HistoryListAdapter.ViewHolder>(DiffCalback()) {

    override fun onCreateViewHolder (parent: ViewGroup, viewTipe: Int) : ViewHolder {
...
class DiffCalback : DiffUtil.ItemCallback<ExchangeResponseValue> () {
    override fun areItemsTheSame(oldItem: ExchangeResponseValue, newItem: ExchangeResponseValue): Boolean = oldItem == newItem
    override fun areContentsTheSame(oldItem: ExchangeResponseValue, newItem: ExchangeResponseValue): Boolean = oldItem.id == newItem.id
}